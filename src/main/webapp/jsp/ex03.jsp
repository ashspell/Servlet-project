...
<body>
	<form method = "post" action = "/jsp/ex03-2.jsp">
	1. 별명 입력 : <input type = "text" name = "nickname"><br>
	
	2. 강아지 or 고양이
	
	<label>강아지<input type = "radio" name = "animals" value = "강아지"></label>
	<label>고양이<input type = "radio" name = "animals" value = "고양이"></label>
	<br>
	3. 다음 중 선호하는 것을 모두 고르세요
